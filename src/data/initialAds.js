export const initialAds = [
  {
    ...
    description:
      "فريقنا المتخصص يزور منزلك ويأخذ القياسات الدقيقة ويقدم لك تصميماً ثلاثي الأبعاد مجانياً وبدون أي التزام. اتصل بنا الآن!",
    discount: null,
    discountText: "مجاناً",
    ...
    ctaLink:
      "https://wa.me/966503167122?text=أريد حجز موعد قياس وتصميم مجاني",
    isActive: true,
    active: true,
    badge: "عرض دائم",
  ...
  },
  {
    ...
    description:
      "نؤمن بجودة منتجاتنا لذلك نقدم ضمان 10 سنوات على الهيكل والتشغيل لجميع خزائننا. راحة بالك مضمونة.",
    discount: null,
    discountText: "10 سنوات",
    validUntil: "2027-12-31",
    colorClass: "from-slate-700 to-slate-900",
    color: "from-blue-900 to-secondary",
    textColor: "text-white",
    image: "/assets/images/ad-warranty.jpg",
    ctaText: "اعرف المزيد",
    ctaLink:
      "https://wa.me/966503167122?text=أريد معرفة تفاصيل الضمان",
    isActive: true,
    active: true,
    badge: "ميزة حصرية",
  ...
  },
  {
    ...
    description:
      "احصل على خصم 30% على تصميم وتركيب غرفة ملابسك الكاملة (Walk-in Closet) عند الحجز خلال هذا الشهر. العرض محدود المدة!",
    discount: 30,
    discountText: "خصم 30%",
    validUntil: "2026-12-31",
    colorClass: "from-amber-700 to-red-800",
    color: "from-red-900 to-dark-800",
    textColor: "text-white",
    image: "/assets/images/ad-walkin-offer.jpg",
    ctaText: "احجز عرضك الآن",
    ctaLink:
      "https://wa.me/966503167122?text=أريد الاستفادة من عرض خصم 30% على غرف الملابس",
    isActive: true,
    active: true,
    badge: "عرض محدود",
